    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                return new Builder().scheme("content").authority(this.mAuthority).encodedPath(sb2.toString()).build();
            } catch (IOException unused) {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                File file = null;
                String str2 = null;
                String attributeValue = loadXmlMetaData.getAttributeValue(str2, ATTR_NAME);
                String attributeValue2 = loadXmlMetaData.getAttributeValue(str2, ATTR_PATH);
